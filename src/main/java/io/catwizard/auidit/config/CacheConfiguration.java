package io.catwizard.auidit.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.catwizard.auidit.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.catwizard.auidit.repository.UserRepository.USERS_BY_EMAIL_CACHE);
